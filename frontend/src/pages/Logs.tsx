    ...
    <div className="h-full flex flex-col gap-4">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time terminal viewer for backend events.</p>
        </div>
      ...
      <Card className="flex-1 bg-black border-white/10 flex flex-col overflow-hidden font-mono text-sm relative">
        
        {/* Terminal Header */}
        <div className="bg-secondary/80 border-b border-white/5 p-2 flex items-center justify-between z-10">
           ...
           <div className="flex gap-2">
             <select className="bg-black/50 border border-white/10 text-white rounded px-2 py-1 text-xs outline-none">
             ...
             <div className="relative">
               ...
               <input type="text" placeholder="Grep..." className="bg-black/50 border border-white/10 rounded px-2 py-1 pl-6 text-xs text-white outline-none w-48" />
             </div>
           </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-1 text-gray-300">
           ...
           <div className="flex gap-4 hover:bg-white/5 px-2 py-0.5 rounded bg-warning/10 text-warning">
           ...
           <div className="flex gap-4 hover:bg-white/5 px-2 py-0.5 rounded bg-danger/10 text-danger">
