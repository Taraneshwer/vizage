...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-secondary flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        <Card className="py-8 px-4 shadow-xl sm:rounded-xl sm:px-10 border-gray-100 bg-white/80 backdrop-blur-md">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary sm:text-sm transition-colors bg-white/50 focus:bg-white"
                  placeholder="admin@vizage.local"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary sm:text-sm transition-colors bg-white/50 focus:bg-white"
                  placeholder="••••••••"
                />
            ...
            {error && (
              <motion.div 
                ...
                className="text-sm text-danger bg-danger/10 p-3 rounded-lg border border-danger/20"
              >
                {error}
              </motion.div>
            )}
